                        ...
                        <tbody class="divide-y divide-slate-100">
                            @foreach ($statement['guests'] as $g)
                                <tr>
                                    ...
                                    <td class="px-3 py-2 text-right tabular-nums">{{ Money::taka(round((float) $g->charge_amount * $mealRate, 2)) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot class="bg-slate-50 font-semibold">
        ...
        <section class="mb-6 rounded-lg border border-slate-200 bg-white p-4">
            ...
            <dl class="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <dd class="text-base font-semibold text-emerald-700">{{ Money::taka($row['advance_applied'] ?? 0) }}</dd>
                </div>
                <div>
