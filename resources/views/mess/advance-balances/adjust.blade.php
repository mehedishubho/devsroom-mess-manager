...
@section('content')
    ...
    <form method="POST" action="{{ route('mess.advance-balances.storeAdjust', $member) }}" class="space-y-4 rounded-lg border border-slate-200 bg-white p-4 sm:p-6">
        @csrf
        <div>
        ...
        <div>
            ...
            <textarea name="reason" id="reason" rows="3" maxlength="500" class="mt-1 block w-full rounded-md border-slate-300 text-sm @error('reason') border-rose-500 @enderror">{{ old('reason') }}</textarea>
