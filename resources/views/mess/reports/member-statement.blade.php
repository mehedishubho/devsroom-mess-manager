...
@section('content')
    ...
    <form method="GET" action="{{ route('mess.reports.member-statement') }}" class="mb-6 flex flex-wrap items-end gap-2">
        ...
        <noscript>
            <button type="submit" class="min-h-[44px] rounded-md bg-slate-800 px-3 py-2 text-sm font-medium text-white">{{ __('Apply') }}</button>
        </noscript>
    </form>
