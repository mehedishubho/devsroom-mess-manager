@php
    ...
    $managerSections[] = [
        ...
        'items' => [
            ...
            ['route' => 'mess.google-sheets.edit', 'match' => 'mess.google-sheets.*', 'label' => __('Google Sheets'), 'icon' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-4 w-4"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3h16.5v18H3.75V3Zm3.75 5.25h9M7.5 12h9m-9 3.75h9"/></svg>'],
